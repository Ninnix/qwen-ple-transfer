...
from canonical_cache import patch_cache, save

here = Path(__file__).parent
source = here.parent / 'kaggle_qwen35_08b_ple_train.ipynb'
out = here / 'kaggle_reader_20m_canonical.ipynb'
...
needle = "assert meta['token_train'] == 20000256 and meta['token_val'] == 524288"
assert scale.count(needle) == 1
scale = scale.replace(needle, "assert meta['token_train'] == 5000192 and meta['token_val'] == 524288")
...
patch_cache(nb, 15000064, 20000000, 'compact-reader-suffix')
save(nb, out)
print(out)
